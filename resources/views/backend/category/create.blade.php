...
@section('content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Create for Category</h1>
    <div class="card mb-3">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" name="category_name" id = "class_name" class="form-control @error('category_name') is-invalid @enderror" placeholder="Enter Category Name">
                                </div>
                                @error('class_name')
