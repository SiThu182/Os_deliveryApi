            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user_detail.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="nrc_no" class="col-md-4 col-form-label text-md-right">{{ __('NRC  No') }}</label>

                            <div class="col-md-6">
                                <input id="nrc_no" type="text" class="form-control @error('nrc_no') is-invalid @enderror" name="nrc_no" value="{{ old('nrc_no') }}" autocomplete="nrc_no" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="custom-select" name="township_id">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address" autofocus></textarea>
