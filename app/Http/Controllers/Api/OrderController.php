...
class OrderController extends Controller
{
    ...
    public function show($voucher_no)
    {
        ...
        $orders = DB::table('orders')
            ...
            ->select('orders.*', 'order_details.id as order_detail_id', 'order_details.menu_id as menu_id', 'order_details.qty as qty', 'order_details.sub_total as sub_total')
